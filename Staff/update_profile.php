...
<body>
    ...
    <div class="row justify-content-center g-0 p-3">
        <div class="col-sm-3 p-3 border-end border-primary text-center ">
            ...
            <a class="nav-link text-light m-2 rounded p-1 "  id="nodo" href="update_profile.php">Edit Profile</a>
    ...
    <div class="col-sm-9 p-3 ">
        <div class="container p-2 bg-primary br-3 text-center">
         ...
         <div class="mb-3">
            ...
            <input type="text" class="form-control text-center" name="new_full_name" value="<?php echo $full_name?>" id="" />
        </div>
        <div class="mb-3">
            <label for="" class="form-label text-primary">Username</label>
            <input type="text" class="form-control text-center" name="new_username" value="<?php echo $username?>" id="" />  
        </div>
        <div class="mb-3">
            <label for="" class="form-label text-primary">Profile Picture</label>
            <input type="file" class="form-control text-center" name="new_profile_pic" value="<?php echo $profile_pic?>" id="" />  
        </div>
        <button name="" id="" class="btn btn-primary " type="submit">Update</button>
         </div>
</form>
