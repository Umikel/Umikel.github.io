    ...
    <div class="row justify-content-center g-0   m-3">
        <div class="col-sm-3 p-3 d-sticky  flex-column flex-shrink-0 kiki rounded shadow ">
            ...
            <ul class="nav nav-pills flex-column mb-auto">
                ...
                <li>
                    <a href="payment.php" class="nav-link active bg-primary text-light">
        ...
        <div class="col-sm-9  p-1">
            ...
            <div class="row justify-content-center align-items-center text-center  g-0 ">
                ...
                <?php } elseif (mysqli_num_rows($check_payment) > 0) { ?>
                    <h1>you have already make a payment</h1>

                <?php } else { ?>
                    <div class="row justify-content-center align-items-center p-2 g-0">
                        <div class=" col-sm-10 border p-3 rounded">
                            <h5 class="text-primary">Step: 1</h5>
                            <p>Clink on <b>"Pay 3,000 Certificate Fee"</b> It will process you to the Payment Page</p>
                            <h5 class="text-primary">Step: 2</h5>
                            <p>Make a payment fee of Three Thousand Naira (N3,000) Only using Master/Visa Card or Throught Bank Transfer.</p>
                            <h5 class="text-primary">Step: 3</h5>
                            <p>After Sucessfull Payment, clink on print your Print Indigene Certificate.</p>

                            <form id="paymentForm" method="post" action="pay.php">
                                <input type="hidden" id="email-address" name="mail" value="<?php echo $email ?>">
                                <input type="hidden" id="amount" name="amount" value="<?php echo $amount ?>">
                                <center><button class="btn btn-primary mb-5 mt-2" name="pay" onclick="payWithPaystack()" id="lo">Pay 3,000 Certificate Fee</button> </center>
                            </form>
                        </div>
                    <?php } ?>
