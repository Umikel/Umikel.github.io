...
if (isset($_POST["llogin"])) {
    ...
    if (mysqli_num_rows($result) > 0) {
        ...
        if ($status === 'verification') {
            $mess["lnote"] = "You have to  verified your first check your email";
        } else {
        ...
        $mess["lnote"] = "Incorrect Email or Password";
    }
}
        ...
        <div class="row justify-content-center g-0 m-3 border rounded ">
            ...
            <nav>
                <div class="nav nav-tabs m-3" id="nav-tab" role="tablist">
                    ...
                    <a href="register.php"><button class="nav-link " id="nav-profile-tab" data-bs-toggle="tab" data-bs-target="#nav-profile" type="button" role="tab" aria-controls="nav-profile" aria-selected="true">Register</button></a>
                    <a href="../index.php"> <button class="nav-link active" id="nav-contact-tab" data-bs-toggle="tab" data-bs-target="#nav-contact" type="button" role="tab" aria-controls="nav-contact" aria-selected="false">Login</button></a>
                </div>
            </nav>



            <div class="col-sm-8 p-3 justify-content-center align-items-center rounded shadow">

                <div class="row mt-5 justify-content-center align-items-center">
                    <h4 class="text-primary text-center">Login </h4>
                    <p class="text-danger text-center"><?php echo $mess['lnote'] ?></p>
                    <div class="col-sm-8 ">
                            ...
                            <div class="row">
                                <div class="col-sm-12 mt-3">
                                    <div class="form-floating">
                                        <input type="email" class="form-control text-center form-control-sm" placeholder="email" name="lemail" value="<?php echo $lemail ?>">
                                        <label for="">Email </label>
                                    </div>
                                </div>
                                <div class="col-sm-12 mt-3">
                                    <div class="form-floating">
                                        <input type="password" class="form-control text-center form-control-sm" placeholder="phone" name="lpassword" value="<?php echo $lpassword ?>">
                                        <label for="">Password</label>
                                    </div>
                                </div>
                            </div>
                            <center> <button class="btn btn-primary mb-5 mt-2 text-center" name="llogin" id="lo">Login</button>
