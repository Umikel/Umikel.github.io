...
session_start();
require '../config.php';
$mess = ['email' => '', 'note' => '', 'answer' => '', 'password' => '', 'cpassword' => ''];
...
if (isset($_POST["submit"])) {
    ...
    if (empty($cpassword)) {
        ...
        if ($update) {
            $mess['note'] = "<script> alert('Congratualation you have been reset your password') </script>";
            header("location: indigene.php");
        } else {
            $mess['note'] = "no way";
        }
        ...
        <div class="col-sm-4 p-3 ">
            ...
            <div class="row mt-5">
                <form action="update_pass.php" method="post" enctype="multipart/form-data">
                    ...
                    <div class="row">
                        <div class="col-sm-12">
                            <label for="">Enter Your New Password <b id="rew">*</b></label>
