...
if (isset($_POST["update_pro"])) {
    ...
    if ($width > 150 || $height > 200) {
        $uploadOk = 0;
        $mess = "The image width is greathan 150px or height is greathan 200px ";
    }
    ...
    if ($uploadOk == 0) {
        ...
        if (move_uploaded_file($_FILES["profile_pic"]["tmp_name"], $target_file)) {
            ...
            $sql = "UPDATE users SET passport = '$target_file' WHERE id = '$id'";
            if ($conn->query($sql) === TRUE) {
                header("Location: user_dashboard.php");
            } else {
                $mess = "Error updating profile picture: " . $conn->error;
            }
        } else {
    ...
    <div class="row justify-content-center g-0   m-3">
        <div class="col-sm-3 p-3 d-sticky  flex-column flex-shrink-0 kiki rounded shadow ">
            ...
            <ul class="nav nav-pills flex-column mb-auto">
                ...
                <li>
                    <a href="upload_image.php" class="nav-link active bg-primary text-light">
        ...
        <div class="col-sm-9  p-1">
            ...
            <div class="row justify-content-center align-items-center text-center  g-0 ">
                ...
                <div class="container p-2 br-3 text-center">
                    <h4 class="text-danger"> <i>Upload Passport</i></h4>
                    <p class="text-danger"><?php echo $mess ?></p>
                </div>
                <div class="row justify-content-center align-items-center p-0 g-0">
                    <div class="col-sm-5 text-start rounded">
                        <h5>Instruction for uploading passport</h5>
                        <ul>
                            <li>passport</li>
                            <li>passport</li>
                            <li>passport</li>
                    ...
                    <div class="col-sm-4  p-1  rounded">
                        <center><img id="prof" src="../image/<?php echo $profile_pic ?>" class="img-fluid " alt="Profile Pic" /> </center>
                        <form action="upload_image.php" method="post" enctype="multipart/form-data">
                            <div class="form-group">
                                <label for="new_username">Profile Picture:</label>
                                <input type="file" id="yes" name="profile_pic" value="<?php echo $profile_pic; ?>" required>
                            </div>
                            <center><button class="btn btn-primary mb-5 mt-2" name="update_pro" id="lo">Update Passport</button> </center>
                    </div>
                    </form>
