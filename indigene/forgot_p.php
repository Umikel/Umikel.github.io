...
<body>
    ...
    <div class="row justify-content-center g-0 p-3">
        ...
        <div class="col-sm-4 p-3 ">
            ...
            <hr>
            <div class="row mt-5">
                <form action="forgot_p.php" method="post" enctype="multipart/form-data">
                    ...
                    <div class="row">
                        <div class="col-sm-12">
                            ...
                            <input type="email" class="form-control text-center form-control-sm" placeholder="Enter your registered Email" name="email" value="<?php echo $email ?>">
