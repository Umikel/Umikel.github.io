    ...
    <div class="row justify-content-center g-0   m-3">
        <div class="col-sm-3 p-3 d-sticky  flex-column flex-shrink-0 kiki rounded shadow ">
            ...
            <ul class="nav nav-pills flex-column mb-auto">
                ...
                <li>
                    <a href="check.php" class="nav-link active bg-primary text-light">
                        <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24">
        ...
        <div class="col-sm-9  p-1">
            ...
            <div class="row justify-content-center align-items-center text-center  g-0 ">
                ...
                <?php } elseif (mysqli_num_rows($check_payment) == 0) { ?>
                    ...
                    <?php } elseif (mysqli_num_rows($check_payment) > 0) {
                    $ver = mysqli_fetch_assoc($check_payment);
                    $status = $ver["status"];
                    if ($status == 'verified') { ?>
                        <h1>Your payment have been verified</h1>
                            ...
                            <div class=" col-sm-10 border p-3 rounded text-center">
                                ...
                                <form method="post" action="check.php">
                                    <div class="form-group">
                                        <p class="text-danger"><?php echo $note ?> </p>
                                        <label for="new_username">Enter Your transaction No:</label> <br>
                                        <input type="text" class="form-control text-center form-control-sm" name="trans" value="" required>
                                    </div>
                                    <center><button class="btn btn-primary mb-5 mt-2" name="check" id="lo">Check my payment</button> </center>
                                </form>
                            </div>
                        <?php }
                } else { ?>
