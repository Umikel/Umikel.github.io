...
<body>
    ...
    <div class="row justify-content-center g-0   m-3">
        <div class="col-sm-3 p-3 d-sticky  flex-column flex-shrink-0 kiki shadow rounded ">
            ...
            <ul class="nav nav-pills flex-column mb-auto">
                ...
                <li>
                    <a href="settings.php" class="nav-link  active text-light">
        ...
        <div class="col-sm-9 p-1 ">
            ...
            <div class="container p-2 br-3 text-center">
                <h4 class="text-danger"> <i>Settings</i></h4>
            </div>
            <div class="row justify-content-center align-items-center p-0 g-0">
                <div class="col-sm-10 ">
                    ...
                    <center><button class="btn btn-primary mb-5 mt-2" name="update" id="lo">Update Record</button> </center>
                </div>
