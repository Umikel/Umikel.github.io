...
$mess = ["ward" => "", "phone" => "", "pass" => "", "dob" => "", "gender" => "", "mstatus" => "", "address" => "", "religion" => "", "pobirth" => "", "ffname" => "", "flname" => "", "mfname" => "", "mlname" => "", "mmname" => "", "maddress" => "", "faddress" => "", "mpobirth" => "", "fpobirth" => ""];
$fname = $lname = $mname = $trans_check = $email = $password = $cpassword = $address = $pobirth = $ffname = $flname = $phone = $fmname = $faddress = $maddress = $mfname = $mlname = $mmname = $mpobirth = $fpobirth = "";
...
$check = mysqli_query($conn, "SELECT * FROM users_records WHERE user_id = '$id'");
...
if (isset($_POST["update"])) {
  ...
  // date
  if (empty($dob)) {
    $mess["dob"] = "Date of Birth Is Required!";
  }
  //gender
  if (empty($_POST["gender"])) {
    $mess["gender"] = "please select your gender";
  } else {
    $gender = $_POST["gender"];
  }
  //marital status
  if (empty($mstatus)) {
    $mess["mstatus"] = "please select your marital status";
  }
  //ward
  if (empty($ward)) {
    $mess["ward"] = "please select your ward";
  }
  //address
  if (empty($address)) {
    $mess["address"] = "please enter your address";
  }

  //place of birth
  if (empty($pobirth)) {
    $mess["pobirth"] = "please enter your place of birth";
  }
  //father's first name
  if (empty($ffname)) {
    $mess["ffname"] = 'Enter your Father\'s First Name';
  } else {
    if (!preg_match('/^[a-zA-Z]*$/', $ffname)) {
      $mess['ffname'] = "Father's First Name: Letters Only!";
    }
  }
  //father's last name
  if (empty($flname)) {
    $mess["flname"] = 'Enter your Father\'s Last Name';
  } else {
    if (!preg_match('/^[a-zA-Z]*$/', $flname)) {
      $mess['flname'] = "Father's Last Name: Letters Only!";
    }
  }
  //father's address
  if (empty($faddress)) {
    $mess["faddress"] = "please enter your father's address";
  }
  //father's religion
  if (empty($freligion)) {
    $mess["freligion"] = "please select your father's religion";
  }

  //father's place of birth
  if (empty($fpobirth)) {
    $mess["fpobirth"] = "please enter your father's place of birth";
  }
  //mother's first name
  if (empty($mfname)) {
    $mess["mfname"] = 'Enter your Mother\'s First Name';
  } else {
    if (!preg_match('/^[a-zA-Z]*$/', $mfname)) {
      $mess['mfname'] = "Mother's First Name: Letters Only!";
    }
  }
  //mother's last name
  if (empty($mlname)) {
    $mess["mlname"] = 'Enter your Mother\'s Last Name';
  } else {
    if (!preg_match('/^[a-zA-Z]*$/', $mlname)) {
      $mess['mlname'] = "Mother's Last Name: Letters Only!";
    }
  }
  //mother's address
  if (empty($maddress)) {
    $mess["maddress"] = "please enter your mother's address";
  }
  //mother's religion
  if (empty($mreligion)) {
    $mess["mreligion"] = "please select your mother's religion";
  }
  //mother's place of birth
  if (empty($mpobirth)) {
    $mess["mpobirth"] = "please enter your mother's place of birth";
  } else {

    // Update the user's profile picture in the database
    $resulty = "INSERT INTO `users_records`(`fname`, `lname`, `mname`, `email`, `phone`, `dob`, `gender`, `mstatus`, `ward`, `Address`, `religion`, `pob`, `ffname`, `flname`, `fmname`, `faddress`, `freligion`, `fpob`, `mfname`, `mlname`, `mmname`, `maddress`, `mreligion`, `mpob`, `user_id`) 
         VALUES ('$fname','$lname','$mname','$email','$phone','$dob','$gender','$mstatus','$ward','$address','$religion','$pobirth','$ffname','$flname','$fmname','$faddress','$freligion','$fpobirth','$mfname','$mlname','$mmname','$maddress','$mreligion','$mpobirth','$id')";
    $querys = mysqli_query($conn, $resulty);
    if ($querys) {
      $mess["note"] = "Profile details updated successfully.";
      header("Location: user_dashboard.php");
    } else {
      echo "Error updating profile details: " . $conn->error;
    }
  }
}
  ...
  <div class="row justify-content-center g-0   m-3">
    <div class="col-sm-3 p-3 d-sticky  flex-column flex-shrink-0 kiki rounded shadow ">
      ...
      <ul class="nav nav-pills flex-column mb-auto">
        ...
        <li>
          <a href="update_details.php" class="nav-link  active bg-primary text-light">
        ...
        <li>
          <a href="print.php" class="nav-link text-primary">
          ...
          if ($photo == "../images/user.png") { ?>
            ...
            <?php } else { ?>
              ...
              <form action="update_details.php" method="post" enctype="multipart/form-data">
                <div class="row mt-5">
                  <h4 class="text-center text-primary"><i>Personal Details </i></h4>
                  <div class="col-sm-4">
                    <label for="">First Name <b id="rew">*</b></label>
                    <input type="text" class="form-control text-center form-control-sm" name="fname" value="<?php echo $fname ?>" disabled readonly>

                  </div>
                  <div class="col-sm-4">
                    <label for="">Last Name <b id="rew">*</b></label>
                    <input type="text" class="form-control text-center form-control-sm" name="lname" value="<?php echo $lname ?>" disabled readonly>
                  </div>
                  <div class="col-sm-4">
                    <label for="">Middle Name</label>
                    <input type="text" class="form-control text-center form-control-sm" name="mname">
                  </div>

                </div>
                <div class="row mt-3">
                  <div class="col-sm-3 col-6">
                    <label for="">Email Address: <b id="rew">*</b>
                      <input type="email" class="form-control text-center form-control-sm" name="email" value="<?php echo $email ?>" disabled readonly>
                    </label>
                  </div>
                  <div class="col-sm-3 col-6">
                    <label for="">Phone Numer: <b id="rew">*</b>
                      <input type="tel" class="form-control text-center form-control-sm" name="phone" value="<?php echo $phone ?>" disabled readonly>
                    </label>
                  </div>
                  <div class="col-sm-3 col-6 text-center">
                    ...
                    <p class="text-danger"><?php echo $mess["dob"] ?></p>
                  </div>
                  <div class="col-sm-3 col-6">
                    <label for="">Gender
                    ...
                    <p class="text-danger"><?php echo $mess["gender"] ?></p>

                  </div>
                  <div class="row mt-2 ">
                    <div class="col-sm-3 col-6">
                      <div class="mb-3">
                        <label for="">Marial Status
                          <select class="form-select form-select-sm form-control" name="mstatus" id="">
                            <option value="single">Single</option>
                            <option value="married">Married</option>
                          </select>
                        </label>
                        <p class="text-danger"><?php echo $mess["mstatus"] ?></p>

                      </div>
                    </div>
                    <div class="col-sm-3 col-6">
                      <label for="">State of origin
                        <input type="text" class="form-control form-control-sm" name="state" value="Kano" disabled readonly>
                      </label>
                    </div>
                    <div class="col-sm-3 col-6">
                      <label for="">LGA
                        <input type="text" class="form-control form-control-sm" name="lga" value="Ungogo" disabled readonly>
                      </label>
                    </div>
                    <div class="col-sm-3 col-6">
                      <div class="mb-3">
                        <label for="">Ward
                          <select class="form-select form-select-sm form-control" name="ward" id="" value="<?php echo $ward ?>">
                            <option value="Bachirawa">Bachirawa</option>
                            <option value="Gayawa">Gayawa</option>
                            <option value="Kadawa">Kadawa</option>
                            <option value="Karo">Karo</option>
                            <option value="Panisau">Panisau</option>
                            <option value="Ranzaga">Ranzaga</option>
                            <option value="Rigiyar Zaki">Rigiyar Zaki</option>
                            <option value="Tudun Fulani">Tudun Fulani</option>
                            <option value="Ungogo">Ungogo</option>
                            <option value="Yadakunya">Yadakunya</option>
                            <option value="Zango">Zango</option>

                          </select>
                        </label>
                        <p class="text-danger"><?php echo $mess["ward"] ?></p>

                      </div>
                    </div>
                    <div class="row mt-2 ">
                      <div class="col-sm-6 col-8">
                        <label for="" class="text-left">Resident Address: <b id="rew">*</b></label>
                        <input type="text" class="form-control text-left form-control-sm" name="address" value="<?php echo $address ?>">
                        <p class="text-danger"><?php echo $mess["address"] ?></p>
                      ...
                      <div class="col-sm-3 col-4">
                        <div class="mb-3">
                          <label for="">Religion
                            <select class="form-select form-select-sm form-control" name="Religion" id="">
                              <option value="islam">Islam</option>
                              <option value="Christian">Christian</option>
                            </select>
                          </label>
                          <p class="text-danger"><?php echo $mess["religion"] ?></p>

                        </div>
                      </div>
                      <div class="col-sm-3 col-8">
                        <label for="" class="text-left">Place of Birth: <b id="rew">*</b></label>
                        <input type="text" class="form-control text-left form-control-sm" name="pobirth" value="<?php echo $pobirth ?>">
                        <p class="text-danger"><?php echo $mess["pobirth"] ?></p>
                  ...
                  <div class="row mt-2">
                    <h4 class="text-center text-primary"><i>Parents Details </i></h4>
                    <div class="col-sm-4">
                      <label for="">Father's First Name <b id="rew">*</b></label>
                      <input type="text" class="form-control text-center form-control-sm" name="ffname" value="<?php echo $ffname ?>">
                      <p class="text-danger"><?php echo $mess["ffname"] ?></p>
                    </div>
                    <div class="col-sm-4">
                      <label for=""> Father's Last Name <b id="rew">*</b></label>
                      <input type="text" class="form-control text-center form-control-sm" name="flname" value="<?php echo $flname ?>">
                      <p class="text-danger"><?php echo $mess["flname"] ?></p>

                    </div>
                    <div class="col-sm-4">
                      <label for="">Father's Middle Name</label>
                      <input type="text" class="form-control text-center form-control-sm" name="fmname" value="<?php echo $fmname ?>">
                    </div>
                  </div>
                  <div class="row mt-2 ">
                    <div class="col-sm-6 col-8">
                      <label for="" class="text-left">Resident Address: <b id="rew">*</b></label>
                      <input type="text" class="form-control text-left form-control-sm" name="faddress" value="<?php echo $faddress ?>">
                      <p class="text-danger"><?php echo $mess["faddress"] ?></p>
                    ...
                    <div class="col-sm-3 col-4">
                      <div class="mb-3">
                        <label for="">Religion
                          <select class="form-select form-select-sm form-control" name="freligion" id="">
                            <option value="islam">Islam</option>
                            <option value="Christian">Christian</option>
                          </select>
                        </label>
                    ...
                    <div class="col-sm-3 col-8">
                      <label for="" class="text-left">Place of Birth: <b id="rew">*</b></label>
                      <input type="text" class="form-control text-left form-control-sm" name="fpobirth" value="<?php echo $fpobirth ?>">
                      <p class="text-danger"><?php echo $mess["fpobirth"] ?></p>
                  ...
                  <div class="row mt-1">
                    <div class="col-sm-4">
                      <label for="">Mother's First Name <b id="rew">*</b></label>
                      <input type="text" class="form-control text-center form-control-sm" name="mfname" value="<?php echo $mfname ?>">
                      <p class="text-danger"><?php echo $mess["mfname"] ?></p>
                    </div>
                    <div class="col-sm-4">
                      <label for=""> Mother's Last Name <b id="rew">*</b></label>
                      <input type="text" class="form-control text-center form-control-sm" name="mlname" value="<?php echo $mlname ?>">
                      <p class="text-danger"><?php echo $mess["mlname"] ?></p>
                    </div>
                    <div class="col-sm-4">
                      <label for="">Mother's Middle Name</label>
                      <input type="text" class="form-control text-center form-control-sm" name="mmname" value="<?php echo $mmname ?>">
                    </div>
                  </div>
                  <div class="row mt-2 ">
                    <div class="col-sm-6 col-8">
                      <label for="" class="text-left">Resident Address: <b id="rew">*</b></label>
                      <input type="text" class="form-control text-left form-control-sm" name="maddress" value="<?php echo $maddress ?>">
                      <p class="text-danger"><?php echo $mess["maddress"] ?></p>
                    ...
                    <div class="col-sm-3 col-4">
                      <div class="mb-3">
                        ...
                        <select class="form-select form-select-sm form-control" name="mreligion" id="">
                          <option value="islam">Islam</option>
                          <option value="Christian">Christian</option>
                        </select>
                    ...
                    <div class="col-sm-3 col-8">
                      <label for="" class="text-left">Place of Birth: <b id="rew">*</b></label>
                      <input type="text" class="form-control text-left form-control-sm" name="mpobirth" value="<?php echo $mpobirth ?>">
                      <p class="text-danger"><?php echo $mess["mpobirth"] ?></p>
                ...
                <p class="text-start mt-3">I certify that the information provided by me on this form is complete,
                  true and accurate. I understand that the information provided by me on this form
                  shall constitute my personal information/data to be entered into
                  the Ungogo lacal Government Database. I consent to sharing of my data
                  provided herein with any organization within the Nigerian Law. I hereby apply for Ungogo
                  Local Government Indigeneship.</p>
                <div class="row justify-content-center align-items-center ">
                  <div class="col-sm-4">

                    <center> <button class="btn btn-primary mb-2 mt-2" name="update" id="lo">Update</button> </center>
                  </div>
